...
export default class DeletePerson extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        return (
            <div>
                ...
                <i className="fas fa-trash fa-sm fa-fw" aria-hidden="true" />  Delete Person
                </Button>
                <Modal isOpen={this.state.modal} toggle={this._toggleModal} size="lg" className="person-color">
                  <div className="modal-header row justify-content-between">
                    ...
                    <ModalBody>
                        <PersonEditValues selectedPerson={this.props.selectedPersonInfo.person} disableEditing={true} />
                        {!this._checkValidToDelete() &&
                        <div>
                            The person you have selected currently has assets assigned to them. Please revoke everything before deleting. 
                        </div>}
                    </ModalBody>
                    <ModalFooter>
                    <Button
    ...
    private _checkValidToDelete = () => {
        return !(this.props.selectedPersonInfo.accessCount > 0 || this.props.selectedPersonInfo.equipmentCount > 0 
            || this.props.selectedPersonInfo.keyCount > 0 || this.props.selectedPersonInfo.workstationCount > 0);
    }
