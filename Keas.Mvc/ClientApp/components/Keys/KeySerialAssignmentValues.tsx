...
export default class KeySerialAssignmentValues extends React.Component<
  IProps,
  {}
> {
  public render() {
      ...
      <div>
        <div className='row justify-content-between mt-5'>
          ...
          <Button
            color='link'
            onClick={() =>
              this.props.openUpdateModal(this.props.selectedKeySerial)
            }
          >
        ...
        <div className='wrapperasset'>
          <div className='form-group'>
            ...
            <input
              ...
              disabled={true}
              value={
                this.props.selectedKeySerial.keySerialAssignment.person.name
              }
            />
          </div>
          <div className='form-group'>
