...
namespace Test.TestsDatabase
{
    ...
    public class AccessTests
    {
        ...
        {
            // Arrange
            var classReflection = new ControllerReflection(_output, typeof(Access));
            // Act
            // Assert	
            classReflection.ControllerInherits("AssetBase"); //Doesn't inherit from another domain object
